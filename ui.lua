-- ================================================================
-- CS:GO MENU UI - BẢN ĐƠN GIẢN, KHÔNG LỖI THU NHỎ
-- ================================================================
...
function CSGOMenu:CreateWindow(title, settings)
    ...
    function self:CreateTab(name)
        ...
        local function createGroupbox(parent, title)
            ...
            frame.Size = UDim2.new(0.95, 0, 0, 0)  -- auto height
            ...
            local function updateHeight()
                ...
                frame.Size = UDim2.new(0.95, 0, 0, h + 6)
            end
            ...
            function group:AddDropdown(text, options, default, callback)
                ...
                btn.MouseButton1Click:Connect(function()
                    ...
                    if open then
                        ...
                        drop.Size = UDim2.new(0.4, 0, 0, #options * 24 + 4)
            ...
            function group:AddColorpicker(text, default, callback)
                ...
                colorBtn.MouseButton1Click:Connect(function()
                    ...
                    closeP.Position = UDim2.new(1, -35, 0, 5)
